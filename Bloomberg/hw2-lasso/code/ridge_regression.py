...
def main():
	...
	fig.savefig('Validation Performance vs Regularization Parameter.pdf')
	fig.show()
	...
	f.savefig('Prediction Functions.pdf')
	f.show()

	f = compare_parameter_vectors(pred_fns)
	f.savefig('Compare Parameter Vectors.pdf')
	f.show()
